...
public class CompanyLegalHistoryJdbcWriterImpl implements CompanyLegalHistoryWriter {

    private static final Logger LOGGER = LoggerFactory.getLogger(CompanyLegalHistoryJdbcWriterImpl.class);
