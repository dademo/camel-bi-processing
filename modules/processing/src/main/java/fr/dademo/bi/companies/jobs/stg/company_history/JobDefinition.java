...
public class JobDefinition extends AbstractApplicationStgJob {
    ...
    public JobDefinition(
        ...
        // Job-specific
        @Nonnull CompanyHistoryItemReader companyHistoryItemReader,
        @Nonnull CompanyHistoryItemMapper companyHistoryItemMapper,
        @Nonnull CompanyHistoryItemWriter companyHistoryItemWriter) {
