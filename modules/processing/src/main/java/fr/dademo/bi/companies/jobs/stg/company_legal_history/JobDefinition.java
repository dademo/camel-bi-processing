...
public class JobDefinition extends AbstractApplicationStgJob {
    ...
    public JobDefinition(
        ...
        // Job-specific
        @Nonnull CompanyLegalHistoryItemReader companyLegalHistoryItemReader,
        @Nonnull CompanyLegalHistoryItemMapper companyLegalHistoryItemMapper,
        @Nonnull CompanyLegalHistoryItemWriter companyLegalHistoryItemWriter) {
