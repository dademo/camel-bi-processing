...
@Slf4j
@Component
public class CompanyInheritanceItemReader extends StgJobItemReader<WrappedRowResource> {
    ...
    public CompanyInheritanceItemReader(@Nonnull DataGouvFrDataQuerierService dataGouvFrDataQuerierService) {
