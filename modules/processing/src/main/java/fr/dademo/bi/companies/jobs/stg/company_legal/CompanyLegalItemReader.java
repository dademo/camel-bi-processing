 ...
 */
@Component
public class CompanyLegalItemReader extends UnidirectionalItemStreamReaderSupport<CSVRecord> {

    private static final Logger LOGGER = LoggerFactory.getLogger(CompanyLegalItemReader.class);
    ...
    private CSVFormat csvFormat() {
        ...
        return CSVFormat.DEFAULT.builder()
            .setHeader(CSV_HEADER_COMPANY_LEGAL)
