...
@Slf4j
@Component
public class CompanyLegalItemReader extends StgJobItemReader<WrappedRowResource> {
    ...
    public CompanyLegalItemReader(@Nonnull DataGouvFrDataQuerierService dataGouvFrDataQuerierService) {
