...
public class JobDefinition extends AbstractApplicationStgJob {
    ...
    public JobDefinition(
        ...
        // Job-specific
        @Nonnull NafDefinitionItemReader nafDefinitionItemReader,
        @Nonnull NafDefinitionItemProcessor nafDefinitionItemProcessor,
        @Nonnull NafDefinitionItemWriter nafDefinitionItemWriter) {
