...
@Slf4j
@Component
public class AssociationItemReader extends StgJobItemReader<WrappedRowResource> {
    ...
    public AssociationItemReader(@Nonnull DataGouvFrDataQuerierService dataGouvFrDataQuerierService) {
