...
public interface DataBackendService {
    ...
    Page<DataBackendDescriptionDto> findAllDataBackends(@Nonnull Pageable pageable);

    Optional<DataBackendDescriptionDto> findDataBackendById(@Min(1) @Nonnull Long id);
}
