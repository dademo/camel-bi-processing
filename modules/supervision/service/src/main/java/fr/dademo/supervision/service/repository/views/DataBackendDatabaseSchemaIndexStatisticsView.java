...
@Builder
@AllArgsConstructor
public class DataBackendDatabaseSchemaIndexStatisticsView {

    private final DataBackendDatabaseSchemaIndexStatisticsEntity dataBackendDatabaseSchemaIndexStatisticsEntity;
