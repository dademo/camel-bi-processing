 ...
 */
@Mapper
public interface DataBackendModuleMetaDataEntityMapper {

    DataBackendModuleMetaDataEntityMapper INSTANCE = Mappers.getMapper(DataBackendModuleMetaDataEntityMapper.class);

    @Mapping(target = "id", ignore = true)
    @Mapping(source = "backendStateExecutions", target = "backendStateExecutions")
    DataBackendModuleMetaDataEntity toDataBackendModuleMetaDataEntity(
