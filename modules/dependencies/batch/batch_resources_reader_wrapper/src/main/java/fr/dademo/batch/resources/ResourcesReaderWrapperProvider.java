...
import fr.dademo.batch.resources.backends.commons_csv.ApacheCommonsCsvResourcesReaderWrapper;
...
public final class ResourcesReaderWrapperProvider {
    ...
    public static ResourcesReaderWrapper of(@Nonnull CSVParser delegate) {
        return new ApacheCommonsCsvResourcesReaderWrapper(delegate, true);
    }
    ...
    public static ResourcesReaderWrapper of(@Nonnull CsvReader delegate, boolean hasHeader) {
        return new FastCsvResourcesReaderWrapper(delegate, hasHeader, true);
    }
    ...
    public static ResourcesReaderWrapper of(@Nonnull NamedCsvReader delegate) {
        return new NamedFastCsvResourcesReaderWrapper(delegate, true);
    }
