package fr.dademo.tools.stream_definitions.configuration;
...
import static fr.dademo.tools.stream_definitions.configuration.HttpConfiguration.CONFIGURATION_PREFIX;
